...
<div class="warning-box">⚠️ 2026-04-17 <br> 렌더링 중인 탭을 선택해둬야만 알림이 정상적으로 오는 버그가 있습니다. 알림을 안정적으로 받고 싶다면 탭을 유지해주세요! </div>  
...
<div class="warning-box">⚠️ PC가 멈추거나 종료되면 감지할 수 없습니다. <br> 대신 디스코드나 텔레그램의 메시지가 업데이트되지 않는다면 PC가 멈춘 것으로 간접적으로 확인할 수 있습니다. </div>  
...
**렌더링 중지**  
렌더링하는 소프트웨어가 종료되거나 렌더링이 중간에 중지되면 알립니다.  
